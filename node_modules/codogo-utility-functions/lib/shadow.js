...
var shadow = exports.shadow = function shadow(height) {
...
var shadowProxy = exports.shadowProxy = new Proxy({}, {
	get: function get(target, height) {
		return {
			...
			"-1": "box-shadow: inset 0 -1px 2px rgba(0,0,0,0.08), inset 0 -1px 2px rgba(0,0,0,0.18);"
		}[height];
	}
});
...
var TilesWrapper = exports.TilesWrapper = _styledComponents2.default.div.withConfig({
	...
	componentId: "sc-6ckxnm-0"
})(["", ";"], mixins.clearfix);

var TileWrapper = exports.TileWrapper = _styledComponents2.default.div.withConfig({
	displayName: "Tiles__TileWrapper",
	componentId: "sc-6ckxnm-1"
})(["width:", ";width:50%;", ";float:left;"], function (props) {
	return props.small ? "50%" : "100%";
}, mixins.xs(_templateObject));

var TileInner = exports.TileInner = _styledComponents2.default.div.withConfig({
	displayName: "Tiles__TileInner",
	componentId: "sc-6ckxnm-2"
...
var TileContent = exports.TileContent = _styledComponents2.default.div.withConfig({
	...
	componentId: "sc-6ckxnm-3"
})(["background:", ";margin-top:-2em;left:0;margin-right:1.5em;margin-bottom:1em;padding:0.5em 1em;p{font-size:0.95em;}"], function (props) {
